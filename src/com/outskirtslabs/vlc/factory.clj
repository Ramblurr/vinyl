(ns com.outskirtslabs.vlc.factory
  ...
  The init! function in this namespace gives you control over when the factory is intialized. You can then pass com.outskirtslabs.vlc.factory/singleton to create-player and co which
